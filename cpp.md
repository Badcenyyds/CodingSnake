...
[点击这里下载](https://raw.githubusercontent.com/seve42/CodingSnake/main/adapter/release/CodingSnake.hpp)
...
9) **`hasObstacle` 与服务端碰撞判定的差异**
   ...
   服务端碰撞结算对“无敌蛇”有额外规则，因此少数情况下会出现：SDK 判断“有障碍”，但服务端该格并不一定会导致你死亡。
...
### 关于时间与回合误差
如果你看到你的蛇总是在食物周围转圈或是看起来很迟钝可能是因为你的系统时间不准确，导致库和服务器之间的通信出现了问题。虽然库会尽力处理这些误差，但仍建议保证系统时间大致正确（例如开启 NTP）。
