...
REM ==============================================
REM build.bat - CMake Build Script for SnakeGame
REM ==============================================
REM Usage:
...
if exist "snake_game.exe" del /q "snake_game.exe"
if exist "snake_game_debug.exe" del /q "snake_game_debug.exe"
echo Clean complete!
echo.
goto end
